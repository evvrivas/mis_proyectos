...
class UsuariosForm(ModelForm):
	class Meta:
		model= Usuarios	
		exclude=["codigo","codigoapk","tipo_usuario","plan_tienda_activo","fecha_inicio_plan","fecha_final_plan","fecha_ingreso","tipo_de_vista","tipo_vista","nota_de_evaluacion"]
...
class TiendasForm(ModelForm):
	class Meta:
		model= Tiendas	
		widgets = {'descripcion': Textarea(attrs={'cols': 30, 'rows': 2}),}	
		exclude=["codigo","tipo_de_vista","codigoapk","id_usuario","fecha_ingreso","n_visitas","ultimo_comentario","ultima_fecha_edicion","plan_publicidad_activo","fecha_inicio_plan","fecha_final_plan","nota_de_evaluacion"]
